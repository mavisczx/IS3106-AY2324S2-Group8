    ...
    <div className = "border m-4 p-4 bg-white rounded drop-shadow-md space-y-2">
      <div className = "flex flex-row space-x-2 items-center text-sm" >
        <div className = "items-center"> 
          <img src = {userProfilePic} className ="rounded-full mx-auto w-10 h-10 shadow-md border-4 border-white"/>
        </div>
      ...
      <div> Post Content Here Lorem Ipsum Whatever Man I Don't Even Care Anymore </div>
